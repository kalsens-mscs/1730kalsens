...
namespace kalsens2EUnitTests
{
    ...
    public class LogicalOperationsUnitTests
    {
        ...
        {
            Assert.IsFalse(LogicalOperations.q02(249));
        }
        [TestMethod]
        public void TestQ01AtMin()
        {
            Assert.IsTrue(LogicalOperations.q02(250));
        }
        [TestMethod]
        public void TestQ01AtMax()
        {
            Assert.IsTrue(LogicalOperations.q02(499));
        }
        [TestMethod]
        public void TestQ01AboveRange()
        {
            Assert.IsFalse(LogicalOperations.q02(500));
        }
        [TestMethod]
